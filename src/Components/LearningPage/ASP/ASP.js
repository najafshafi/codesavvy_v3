    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#b30000" : "inherit",
...
const ASPTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.asp_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.asp_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-red-700">ASP</h1>
        <TutorialSection
