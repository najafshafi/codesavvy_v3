    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#9CA3AF" : "inherit",
...
const RWDTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.rwd_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.rwd_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-gray-400">RWD</h1>
        <TutorialSection
