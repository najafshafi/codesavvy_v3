    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#b91c1c" : "inherit",
...
const JSONTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.json_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.json_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-red-700">JSON</h1>
        <TutorialSection
