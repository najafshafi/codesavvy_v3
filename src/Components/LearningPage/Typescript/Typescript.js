...
import topics from "./Typescript.json";
import "../Web.css";
...
const TypescriptTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.typescript_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.typescript_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-blue-500">Typescript</h1>
        <TutorialSection
