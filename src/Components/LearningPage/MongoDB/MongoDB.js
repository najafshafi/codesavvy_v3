...
import topics from "./MongoDB.json";
import "../Web.css";
    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#22c55e" : "inherit",
...
const MongoDBTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.mongodb_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.mongodb_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-green-500">MongoDB</h1>
        <TutorialSection
