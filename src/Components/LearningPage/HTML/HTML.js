    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#f06529" : "inherit",
...
const HtmlTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.html_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.html_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-orange-500">HTML</h1>
        <TutorialSection
