...
import topics from "./Canvas.json";
import "../Web.css";
    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#c2410c" : "inherit",
...
const CanvasTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.canvas_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.canvas_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-orange-700">Canvas</h1>
        <TutorialSection
