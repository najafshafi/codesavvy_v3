    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#cc6699" : "inherit",
...
const SassTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.sass_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.sass_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-pink-700">Sass</h1>
        <TutorialSection
