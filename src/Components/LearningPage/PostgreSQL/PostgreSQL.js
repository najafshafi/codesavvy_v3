...
import topics from "./PostgreSQL.json";
import "../Web.css";
    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#0c4a6e" : "inherit",
...
const PostgreSQLTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.postgresql_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.postgresql_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-sky-900">PostgreSQL</h1>
        <TutorialSection
