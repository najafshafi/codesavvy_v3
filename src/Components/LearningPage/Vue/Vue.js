    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#16A34A" : "inherit",
...
const VueTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.vue_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.vue_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-green-600">Vue</h1>
        <TutorialSection
