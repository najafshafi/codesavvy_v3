...
const HowToTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.howto_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.howto_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className=" text-5xl text-blue-600">How To</h1>
        <TutorialSection
