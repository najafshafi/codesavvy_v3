...
import topics from "./MatlabPilot.json";
import "../Web.css";
    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#F97316" : "inherit",
...
const MatlabPilotTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(
    topics.matlabpilot_tutorial[0]
  );
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.matlabpilot_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-orange-500">Matlab Pilot</h1>
        <TutorialSection
...
export default MatlabPilotTutorial;
