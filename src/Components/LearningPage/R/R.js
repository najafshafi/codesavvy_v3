    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#276dc2" : "inherit",
...
const RTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.r_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.r_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-blue-800">R</h1>
        <TutorialSection
