...
const APPMLTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.appml_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.appml_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-red-500">APPML</h1>
        <TutorialSection
