...
import topics from "./Kotlin.json";
import "../Web.css";
    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#9333EA" : "inherit",
...
const KotlinTutorial = () => {
  const [selectedTopic, setSelectedTopic] = useState(topics.kotlin_tutorial[0]);
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.kotlin_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-purple-600">Kotlin</h1>
        <TutorialSection
