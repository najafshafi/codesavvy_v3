    ...
    <ul className="topic-list">
      {topics.map((topic, index) => (
        <li
          ...
          style={{
            backgroundColor:
              selectedTopic.title === topic.title ? "#ffde57" : "inherit",
...
const SciPyTutorial = () => {
  ...
  return (
    <div className="container">
      <Sidebar
        topics={topics.scipy_tutorial}
        onTopicSelect={handleTopicSelect}
        selectedTopic={selectedTopic}
      />
      <div className="content">
      <h1 className="text-5xl text-yellow-200">SciPy</h1>
        <TutorialSection
