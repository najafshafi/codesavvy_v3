...
const QuizList = () => {
    ...
    return (
        ...
        //                 <QuizImage src="https://media.istockphoto.com/id/1186386668/vector/quiz-in-comic-pop-art-style-quiz-brainy-game-word-vector-illustration-design.jpg?s=612x612&w=0&k=20&c=mBQMqQ6kZuC9ZyuV5_uCm80QspqSJ7vRm0MfwL3KLZY=" alt="Quiz Image" />
        //                 <QuizTitle>{quiz.title}</QuizTitle>
        //                 <InfoText>Topics: <span className='topics'>{quiz.category || "General, General, General"}</span></InfoText>
        //                 <div className='Wardflex'>
        //                     <InfoText><span className='diff'>Difficulty:</span> {quiz.difficulty}</InfoText>

        //                     <div>
        //                         <InfoText>Attempts: {quiz.attempts}</InfoText>
        //                         <InfoText>Score: {quiz.score}</InfoText>
