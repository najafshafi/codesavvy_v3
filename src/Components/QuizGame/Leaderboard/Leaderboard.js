...
//     const [users, setUsers] = useState(generateRandomScores());
//     const order = useRef(users.map((_, i) => i));
//     const [springs, api] = useSprings(users.length, calculateStyles(order.current));

//     // Update user scores every 2 seconds
//     useEffect(() => {
...
//                 }));
//                 return updatedUsers.sort((a, b) => b.score - a.score); // Sort by descending scores
//             });
//         }, 2000);
