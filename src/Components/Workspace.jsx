    ...
    <div className="flex justify-center items-center bg-white overflow-x-hidden">
      <div className="relative max-w-7xl gap-10 flex flex-col md:flex-row justify-between items-center px-8 md:px-16 py-16 ">
        ...
        <div className="flex flex-col w-full smd:w-[75%] md:w-[45%] lg:w-1/2 gap-7 justify-center h-auto px-4 sm:px-8 lg:px-12 sm:text-center lg:text-left">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 text-justify lg:text-left">
          ...
          <button
            type="submit"
            class="flex smd:mx-auto md:mx-0 lg:mx-0 w-fit md:w-[250px] lg:w-fit sm:justify-start md:justify-evenly gap-2 items-center shadow-xl text-lg text-blue-500 backdrop-blur-md lg:font-semibold isolation-auto border-blue-500 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-blue-500 hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
            >
            <span>Try it Yourself</span>
            <svg
              class="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-blue-500 bg-blue-500 ease-linear duration-300 rounded-full border border-blue-500 group-hover:border-none p-2 rotate-45"
              viewBox="0 0 16 19"
              xmlns="http://www.w3.org/2000/svg"
              >
              <path
                d="M7 18C7 18.5523 7.44772 19 8 19C8.55228 19 9 18.5523 9 18H7ZM8.70711 0.292893C8.31658 -0.0976311 7.68342 -0.0976311 7.29289 0.292893L0.928932 6.65685C0.538408 7.04738 0.538408 7.68054 0.928932 8.07107C1.31946 8.46159 1.95262 8.46159 2.34315 8.07107L8 2.41421L13.6569 8.07107C14.0474 8.46159 14.6805 8.46159 15.0711 8.07107C15.4616 7.68054 15.4616 7.04738 15.0711 6.65685L8.70711 0.292893ZM9 18L9 1H7L7 18H9Z"
                class="fill-white group-hover:fill-blue-500"
              ></path>
            </svg>
          </button>
                </a>
